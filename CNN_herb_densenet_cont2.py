...
IMAGE_CHANNELS=3
NAME = "flowering-vs-non_flowering-densenet-256-cont2-{}".format(int(time.time()))
# 
...
model = load_model('flowering_densenet_256_cont_82.014%.hdf5')
...
filepath="flowering_densenet_256_cont2.hdf5"
...
train_path = '/gpfs/loomis/home.grace/dollar/teo22/project/Herbarium/Train_Resized2'
valid_path = '/gpfs/loomis/home.grace/dollar/teo22/project/Herbarium/Valid_Resized2'
...
model.save("flowering_densenet_256_cont2.h5")
