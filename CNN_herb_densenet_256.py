...
IMAGE_CHANNELS=3
NAME = "flowering-vs-non_flowering-densenet-256-{}".format(int(time.time()))
...
filepath="flowering_densenet_256.hdf5"
...
epochs=3 if FAST_RUN else 5000
...
model.save("flowering_densenet_256.h5")
